...
"""
function test_flux_forecaster(problem_iterator::ProblemIterator, file_in::AbstractString, file_out::AbstractString)
    @testset "Flux.jl & MLJ.jl" begin
        ...
        output_variables = output_data[!, Not([:id, :status, :primal_status, :dual_status, :objective, :time])]
